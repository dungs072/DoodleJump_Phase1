...
class UIManager implements RenderInterface{
    ...
    private setUI(): void{
        ...
        this.mainMenuUI = new MainMenuUI(new Vector2(0, 0), new Vector2(640,600), backgroundMainMenu);
        let playGameButtonBg = new Sprite(PathResources.PLAY_GAME, new Vector2(0, 0));
        this.startGameButton = new Button(new Vector2(100, 200), new Vector2(222, 80), "", "", playGameButtonBg)
        ...
        this.gameOverMenuUI = new GameOverMenuUI(new Vector2(0, 0), new Vector2(640,600), backgroundGameOverMenu);
        let playAgainButtonBg = new Sprite(PathResources.PLAY_AGAIN_BUTTON, new Vector2(0, 0));
        this.playAgainButton = new Button(new Vector2(280, 350), new Vector2(224, 82), "", "", playAgainButtonBg)
        ...
        this.menuButton = new Button(new Vector2(350, 500), new Vector2(224, 82), "", "", menuButtonBg)
